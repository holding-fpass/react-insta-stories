    ...
    return (
        <div style={{ ...storyContainerStyles, ...styles.container, ...{ width, height } }}>
            ...
            {!preventDefault && <div style={styles.overlay}>
                <div style={{width: '50%', height: '100%',  zIndex: 999}} onTouchStart={debouncePause} onTouchEnd={mouseUp('previous')}
                     onMouseDown={debouncePause} onMouseUp={mouseUp('previous')}/>
                <div style={{width: '50%', height: '100%', zIndex: 999}} onTouchStart={debouncePause} onTouchEnd={mouseUp('next')}
